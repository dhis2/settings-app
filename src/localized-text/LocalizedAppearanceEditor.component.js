...
class LocalizedTextEditor extends React.Component {
    static getLocaleName(code) {
        return (
            (configOptionStore.state &&
                configOptionStore
                    .getState()
                    .locales.filter(locale => locale.id === code)
    ...
    constructor(props, context) {
        ...
        this.state = {
            ...
            localeName: LocalizedTextEditor.getLocaleName(context.d2.system.settings.settings.keyUiLocale),
        };
    ...
    render() {
        ...
        const fields = keys.map(key => ({
            ...
            value:
                (settingsStore.state &&
                    settingsStore.state[key + localeAppendage]) ||
                '',
            component: TextField,
            props: {
