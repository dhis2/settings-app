                ...
                Promise.all([
                    ...
                    results => {
                        ...
                        Object.keys(results[0]).forEach(key => {
                            ...
                            results[0][key] =
                                v !== null && !isNaN(v) ? v.toString() : v // eslint-disable-line no-param-reassign
                        })
                        ...
                        if (settingsKeyMapping[settingsKey].searchLabels) {
                            settingsKeyMapping[
                                ...
                                if (!d2.i18n.isTranslated(label)) {
                                    log.warn(
                                        `No translation found for ${label} under ${settingsKey}`
                                    )
                                }
                            })
    ...
    return settingsSearchMap
        ...
        .map(results => {
            if (
                ...
                settingsKeyMapping.hasOwnProperty(searchTerms[0])
            ) {
